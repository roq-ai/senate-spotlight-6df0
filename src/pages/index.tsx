...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Senate Spotlight`}</title>

        <meta
          name="description"
          content="for all things news, jobs, and beyond. Dive into the world of Senate Spotlight - your hub for staying informed, connected and ahead."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1495020689067-958852a7765e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxuZXdzfGVufDB8fHx8MTY5NDUwMTAyNXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`for all things news, jobs, and beyond. Dive into the world of Senate Spotlight - your hub for staying informed, connected and ahead.`}
            </Text>
            <Box
