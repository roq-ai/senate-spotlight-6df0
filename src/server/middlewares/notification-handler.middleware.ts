...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'news.create': {
    roles: ['administrator'],
    key: 'news-article-created',
    tenantPath: ['organization', 'news'],
    userPath: [],
  },
  'news.update': {
    roles: ['administrator'],
    key: 'news-article-updated',
    tenantPath: ['organization', 'news'],
    userPath: [],
  },
  'news.delete': {
    roles: ['administrator'],
    key: 'news-article-deleted',
    tenantPath: ['organization', 'news'],
    userPath: [],
  },
  'job.create': {
    roles: ['administrator'],
    key: 'job-posting-created',
    tenantPath: ['organization', 'job'],
    userPath: [],
  },
  'job.update': {
    roles: ['administrator'],
    key: 'job-posting-updated',
    tenantPath: ['organization', 'job'],
    userPath: [],
  },
  'job.delete': {
    roles: ['administrator'],
    key: 'job-posting-deleted',
    tenantPath: ['organization', 'job'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['administrator', 'content-creator', 'job-poster'];
